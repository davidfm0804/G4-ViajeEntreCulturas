<main>
    ...
    <script src="<?php echo JS_MODEL.'mPais.js';?>"></script>
    <script src="<?php echo JS_CONTROLLER.'cPais.js';?>"></script>
    <script>
        // Coger el valor de un parámetro de la URL 
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const scriptToLoad = getParam('script');
